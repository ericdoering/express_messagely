...
class User {
  ...
  static async messagesFrom(username) {
    ...
    m.body, m.sent_at, m.read_at FROM messages AS m JOIN users AS u ON m.to_username = u.username
  ...
  static async messagesTo(username) {
    const result = await db.query(`SELECT m.id, m.from_username, u.first_name, u.last_name, u.phone,
    m.body, m.sent_at, m.read_at FROM messages AS m JOIN users AS u ON m.from_username = u.username
